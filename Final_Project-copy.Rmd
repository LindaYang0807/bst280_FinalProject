...
#### Panda Network Interpretation

These figures display the PANDA gene regulatory network for ER+ and ER- breast cancers, showing the two 200 strongest regulatory edges by weight. As shown, the two breast cancer subtypes are quite different at the regulatory level. The dense red clusters in ER+ and ER- breast cancer show the genes that are consistently expressed in the subtypes, respectively. Of note, some of the genes that are expressed in the PANDA networks are not shown in the top differentially targeted transcription factors (next figure). Differential targeting compares the subtypes while the PANDA networks only show the strongest edges within each condition. 
